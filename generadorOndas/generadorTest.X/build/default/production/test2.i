...
setup256:
    banksel TRISA
    bsf ((OPTION_REG) and 07Fh), 2 ;1:256
...
setup128:
    banksel TRISA
    bsf ((OPTION_REG) and 07Fh), 2 ;1:128
    bsf ((OPTION_REG) and 07Fh), 1
...
setup064:
    banksel TRISA
    bsf ((OPTION_REG) and 07Fh), 2 ;1:064
...
setup032:
    banksel TRISA
    bsf ((OPTION_REG) and 07Fh), 2 ;1:032
    bcf ((OPTION_REG) and 07Fh), 1
    bcf ((OPTION_REG) and 07Fh), 0
    restart_tmr0
    return
...
setup016:
    banksel TRISA
    bcf ((OPTION_REG) and 07Fh), 2 ;1:016
    bsf ((OPTION_REG) and 07Fh), 1
    bsf ((OPTION_REG) and 07Fh), 0
    restart_tmr0
    return
...
setup008:
    banksel TRISA
    bcf ((OPTION_REG) and 07Fh), 2 ;1:008
    bsf ((OPTION_REG) and 07Fh), 1
    bcf ((OPTION_REG) and 07Fh), 0
    restart_tmr0
    return
...
setup004:
    banksel TRISA
    bcf ((OPTION_REG) and 07Fh), 2 ;1:004
    bcf ((OPTION_REG) and 07Fh), 1
    bsf ((OPTION_REG) and 07Fh), 0
    restart_tmr0
    return
...
setup002:
    banksel TRISA
    bcf ((OPTION_REG) and 07Fh), 2 ;1:002
    bcf ((OPTION_REG) and 07Fh), 1
    bcf ((OPTION_REG) and 07Fh), 0
    restart_tmr0
    return
...
config_tmr1:
    ...
    bsf ((T1CON) and 07Fh), 5 ;prescaler 8:1
